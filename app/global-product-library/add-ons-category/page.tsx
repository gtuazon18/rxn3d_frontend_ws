    ...
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-gray-50/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900">{t("Global Add-ons Category Management")}</h1>
        ...
        <Table className="w-full table-auto">
          <TableHeader>
            <TableRow className="bg-gray-50/80 hover:bg-gray-50">
              ...
              <TableHead className="font-semibold text-gray-900 text-left min-w-[100px] whitespace-nowrap">{t("Status")}</TableHead>
              ...
              displayData.map((category: any) =>
                category.subcategories && category.subcategories.length > 0 ? (
                  ...
                  <TableRow key={`cat-${category.id}`} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                    ...
                    <TableCell className="text-left whitespace-nowrap">{/* subcategory code */}--</TableCell>
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={
      ...
      <DeleteConfirmationModal
        ...
        itemName={isBulkDelete ? t("add-on categories") : t("add-on category")}
        itemCount={isBulkDelete ? deleteIds.length : undefined}
