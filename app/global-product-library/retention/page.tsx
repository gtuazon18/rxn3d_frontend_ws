...
import { Search, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, Edit, TrashIcon, Copy, Plus, Package } from 'lucide-react'
...
export default function RetentionPage() {
  ...
  useEffect(() => {
    fetchRetentions(currentPage, entriesPerPage, searchTerm)
          ...
          {selectedRetentions.length > 0 && (
            <div className="ml-6 flex items-center gap-2">
              <span className="text-sm font-medium text-gray-700">
                {selectedRetentions.length} selected
              </span>
              <Button
                variant="outline"
                size="sm"
          ...
          <TableBody>
            {retentions.map((retention, index) => (
              ...
              >
                ...
                <TableCell className="text-gray-600">{retention.code}</TableCell>
                <TableCell>
                  <Badge
                    variant={retention.status === "Active" ? "default" : "secondary"}
                    className={
          ...
          <div className="text-center py-12">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <h3 className="font-medium text-gray-900 mb-1">No retentions found</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Get started by creating your first retention type
                </p>
                <Button
