        ...
        <Table className="w-full table-auto">
          <TableHeader>
            <TableRow className="bg-gray-50/80 hover:bg-gray-50">
              ...
              <TableHead className="font-semibold text-gray-900 px-2 text-left" style={{ width: "1%" }}>{t("Add-on Category")}</TableHead>
              <TableHead className="font-semibold text-gray-900 px-2 text-left" style={{ width: "1%" }}>{t("Category Code")}</TableHead>
              <TableHead className="font-semibold text-gray-900 px-2 text-left" style={{ width: "1%" }}>{t("Add-on Sub Category")}</TableHead>
              <TableHead className="font-semibold text-gray-900 px-2 text-left" style={{ width: "1%" }}>{t("Sub Category Code")}</TableHead>
              <TableHead className="font-semibold text-gray-900 text-center w-20 px-2">{t("Actions")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isLoadingAddOns ? (
              ...
              addOns.map((category) =>
                category.subcategories && category.subcategories.length > 0 ? (
                    ...
                    <TableRow key={`cat-${category.id}-sub-${subcat.id}`} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                      {idx === 0 ? (
                        <>
                          ...
                          <TableCell
                            rowSpan={category.subcategories.length}
                            className="font-medium text-gray-900 align-middle px-2"
                            style={{ verticalAlign: "middle" }}
                          >
                            <div className="h-full flex flex-col justify-center">
                              <span className="whitespace-nowrap" title={category.name || "--"}>
                      ...
                      <TableCell className="font-medium text-gray-900 px-2">{subcat.name ? subcat.name : "--"}</TableCell>
                  ...
                  <TableRow key={`cat-${category.id}`} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                    ...
                    <TableCell className="font-medium text-gray-900 px-2 whitespace-nowrap">
